  ...
  request.onreadystatechange = function () {
    if (request.readyState === 4 && request.status === 200) {
      ...
      if (request.responseText !== '') {
        ...
        console.log(data);
        var buttons1 = document.querySelectorAll('.add-cart');

        var _iterator = _createForOfIteratorHelper(buttons1),
            _step;

        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var button1 = _step.value;
            var id = button1.getAttribute('id');
...
__webpack_require__(/*! /home/ignat/dev/blog/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/ignat/dev/blog/resources/sass/app.scss */"./resources/sass/app.scss");
